...
function Notifications() {
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      try {
        const response = await axios.get(`https://${import.meta.env.VITE_API_URL}/api/notifications/${user.uid}`)
  ...
  const handleMarkAsRead = async (nid) => {
    try {
      await axios.put(`https://${import.meta.env.VITE_API_URL}/api/notifications/${nid}/read`)
  ...
  const handleMarkAllAsRead = async () => {
    try {
      ...
      await Promise.all(unread.map(n =>
        axios.put(`https://${import.meta.env.VITE_API_URL}/api/notifications/${n.nid}/read`)
      ))
